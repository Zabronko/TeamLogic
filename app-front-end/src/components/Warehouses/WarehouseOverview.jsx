        ...
        if (mode === 'read') {
            return (
                <>
                    ...
                    <Card style={{ border: "none", width: "90%", marginLeft: "5%", alignContent: "center" }}>
                        ...
                        <PackageList trucks={warehouse.trucks} mode={'read'} warehouse={warehouse} />
                    </Card>
                </>
            );
            ...
            return (
                <>
                    ...
                    <Card style={{ border: "none", width: "90%", marginLeft: "5%", alignContent: "center" }}>
                        <h2 style={{ textAlign: "center" }}>Packages</h2>
                        <Button onClick={() => { setMode('read'); setUpdate(['update'])}}>Save</Button>
                        <PackageList trucks={warehouse.trucks} mode={'edit'} warehouse={warehouse} />
                    </Card>
                </>
            );
        }
